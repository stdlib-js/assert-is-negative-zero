...
-   [`@stdlib/assert/is-positive-zero`][@stdlib/assert/is-positive-zero]: test if a value is equal to positive zero.
...
[test-image]: https://github.com/stdlib-js/assert-is-negative-zero/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/assert-is-negative-zero/actions/workflows/test.yml
